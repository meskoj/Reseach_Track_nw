...
The objective is for the robot to reach a user-specified target point. The environment and the algorithm governing the robot's movements have already been implemented and can be referenced from the existing [project](https://github.com/CarmineD8/assignment_2_2023).
For more information check [documentation](https://meskoj.github.io/ResearchTrack1_Second_Assignment/)
